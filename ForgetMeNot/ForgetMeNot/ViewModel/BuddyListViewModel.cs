...
[ObservableObject]
public partial class BuddyListViewModel
{
    ...
    public BuddyListViewModel(BuddyService buddyService)
    {
    ...
    public async Task Init()
    {
        try
        {
            Buddies = buddyService.GetBuddies();
        }
        catch (Exception)
        {
            // TODO: logging
            Debug.WriteLine("Unable to retrieve buddy list");
        }
    }
